...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2024 at 04:48 PM
...
INSERT INTO `salary_details` (`salary_id`, `TotalSalary_id`, `basic_salary`, `thirteenth_month_pay`, `overtime_hours`, `regular_overtime_rate`) VALUES
(1, 1, 2352.00, 0.00, 8.00, 24.50),
(3, 3, 536.00, 0.00, 0.00, 16.75),
(4, 4, 2352.00, 0.00, 8.00, 24.50);
...
(7, 'hsy@itemployee.com', 'hsy', 2),
(8, 'jade@finance.com', 'jade', 2);
...
(4, 1, 2548.00, 300.00, 2248.00, '2024-05-10', 4);
...
--
ALTER TABLE `tbl_login_role`
  MODIFY `login_role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `total_salary`
  MODIFY `TotalSalary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
